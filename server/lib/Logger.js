...
class Logger {
  ...
  static log(...args) {
    console.log(`${Logger.#getTimestamp()}: `, ...args);    
  }

  static info(...args) {
    console.info(`${Logger.#getTimestamp()}: `, ...args);    
  }

  static warn(...args) {
    console.warn(`${Logger.#getTimestamp()}: `, ...args);    
  }

  static error(...args) {
    console.error(`${Logger.#getTimestamp()}: `, ...args);    
  }

  static debug(...args) {
    console.debug(`${Logger.#getTimestamp()}: `, ...args);    
  }
